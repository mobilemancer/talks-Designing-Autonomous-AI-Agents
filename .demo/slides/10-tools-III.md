...
| Deep Research (preview)                   | Use OpenAI's advanced agentic research capability for analysis and reasoning.                                        |
| File Search                               | Augment agents with knowledge from outside its model, such as proprietary product information or user documents.     |
| Function calling                          | Describe the structure of functions you create to an agent and have them be called during interactions.              |
